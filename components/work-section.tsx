  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-muted-foreground tracking-wide text-[clamp(0.8rem,1.9vw,0.875rem)]">— {project.category}</span>
      </div>
    </motion.div>
  )
}
...
export default function WorkSection() {
  ...
  return (
    <section ref={sectionRef} id="work" className="py-16 lg:py-40 px-4 sm:px-6 lg:px-8 bg-white relative z-20">
      <div className="container mx-auto w-full max-w-screen-2xl">
        ...
        <div ref={headingRef} className="flex mb-10 lg:mb-14">
          ...
          <h2 className="caret-transparent text-md text-right text-ellipsis lg:text-4xl xl:text-5xl font-sans font-normal leading-[1.4]  tracking-tight">
